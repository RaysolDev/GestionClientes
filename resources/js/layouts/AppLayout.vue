<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <!-- Desktop Sidebar -->
    <aside
      class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700"
    >
    ...
    <nav
      class="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-50"
    >
    ...
    <!-- Main Content -->
    <div class="md:pl-64 pb-16 md:pb-0">
      <main class="py-6">
